...
** before beginning, I'd like to thank [rrjoson](https://github.com/rrjoson/) for sharing really helpful instruction.

### Project Description

Take a baseline installation of a Linux distribution on a virtual machine and prepare it to host your web applications, to include installing updates, securing it from a number of attack vectors and installing/configuring web and database servers.

- IP address: 34.215.140.134
...
1. Create new user named grader and give it the permission to sudo
  - SSH into the server through `ssh -i ~/.ssh/udacity_key.rsa root@34.215.140.134`
...
3. Change SSH port from 22 to 2200
  ...
  - Confirm by running `ssh -i ~/.ssh/udacity_key.rsa -p 2200 root@34.215.140.134`
...
7. Disable ssh login for root user
  ...
  - Now you are only able to login using `ssh -i ~/.ssh/udacity_key.rsa -p 2200 grader@34.215.140.134`
...
10. Clone the Catalog app from Github
  ...
  - `cd /catalog`
  - Clone your project from github `git clone https://github.com/nicky7711/Catalog_flask_fullstack.git catalog`
...
14. Configure and enable a new virtual host
  ...
  ```
  <VirtualHost *:80>
      ServerName 34.215.140.134
      ServerAlias ec2-34-215-140-134.us-west-2.compute.amazonaws.com
      ServerAdmin admin@34.215.140.134
...
17. Visit site at [http://34.215.140.134](http://34.215.140.134)
